...
#ifndef BACKGROUNDSUBTRACTION_PBAS_PBAS_H_
#define BACKGROUNDSUBTRACTION_PBAS_PBAS_H_
...
public:
	PBAS(void);
	~PBAS(void);
	bool process(cv::Mat* input, cv::Mat* output, cv::Mat* bg_model);
...
#endif /* BACKGROUNDSUBTRACTION_PBAS_PBAS_H_ */
